...
{{-- This component is used to display a clap button with an icon and a count of claps. --}}
{{-- The button is styled to be interactive and visually appealing. --}}
{{-- CLAP SECTION --}}
<div x-data="{
    hasClapped: {{ auth()->user() && $post->claps()->where('user_id', auth()->id())->exists() ? 'true' : 'false' }},
    ...
    <button @click="clap()"
        class="flex items-center p-1 gap-1 justify-center rounded-full hover:bg-gray-200 hover:text-gray-700 transition"
        id="ClapButton">
